...
transformation, and replaces everything after the `---` separator — preserving
this header section intact. Review the diff, then commit.

## Config Reference

The sections below document every available Ghostty configuration option with
its description and default value. Edit `config` to override any of these.
...
Default: `freetype-load-flags = hinting,no-force-autohint,no-monochrome,autohint`
...
Default: `keybind = super+alt+shift+j=write_screen_file:open`
...
Default: `keybind = super+bracket_left=goto_split:previous`
...
Default: `keybind = super+shift+bracket_left=previous_tab`

Default: `keybind = super+shift+,=reload_config`

Default: `keybind = super+,=open_config`

Default: `keybind = super+ctrl+shift+j=write_screen_file:copy`

Default: `keybind = paste=paste_from_clipboard`

Default: `keybind = super+bracket_right=goto_split:next`
...
Default: `keybind = super+equal=increase_font_size:1`
...
Default: `keybind = super+ctrl+equal=equalize_splits`
...
Default: `keybind = super+c=copy_to_clipboard`
...
Default: `keybind = copy=copy_to_clipboard`

Default: `keybind = super+shift+j=write_screen_file:paste`

Default: `keybind = super+shift+bracket_right=next_tab`
...
Available since: 1.2.0
Default: `command-palette-entry = title:"Change Title...",description:"Prompt for a new title for the current terminal.",action:"prompt_surface_title"`
...
Default: `command-palette-entry = title:"Copy Screen to Temporary File and Copy Path",description:"Copy the screen contents to a temporary file and copy the path to the clipboard.",action:"write_screen_file:copy"`

Default: `command-palette-entry = title:"Copy Screen to Temporary File and Open",description:"Copy the screen contents to a temporary file and open it.",action:"write_screen_file:open"`

Default: `command-palette-entry = title:"Copy Screen to Temporary File and Paste Path",description:"Copy the screen contents to a temporary file and paste the path to the file.",action:"write_screen_file:paste"`

Default: `command-palette-entry = title:"Copy Selection to Temporary File and Copy Path",description:"Copy the selection contents to a temporary file and copy the path to the clipboard.",action:"write_selection_file:copy"`

Default: `command-palette-entry = title:"Copy Selection to Temporary File and Open",description:"Copy the selection contents to a temporary file and open it.",action:"write_selection_file:open"`

Default: `command-palette-entry = title:"Copy Selection to Temporary File and Paste Path",description:"Copy the selection contents to a temporary file and paste the path to the file.",action:"write_selection_file:paste"`
...
Default: `command-palette-entry = title:"Copy to Clipboard",description:"Copy the selected text to the clipboard.",action:"copy_to_clipboard"`
